...
// puedes volver a correr get-personas.js para comprobar que se ha eliminado
...
app.get('/persona/:name', async (req, res) => {
  console.log("req.params", req.params);
  const personas = await getPersonas();
  const persona = personas.find(p => p.name === req.params.name);
  if (!persona) {
